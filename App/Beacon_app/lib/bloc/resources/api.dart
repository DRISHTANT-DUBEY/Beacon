...
class ApiProvider {
  ...
  Future signinUser(String username, String password, String apiKey) async {
    //We need to change the I.P ADDRESS OF Local Machine in the frontend to achive local port interaction of the AVD passing through local machine Ip Address
